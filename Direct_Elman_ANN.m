...
%     '(12) Remove all Transformations if applied'};
    ...
    A = {'Minimum MSE=';MinMSE;'Size of Train Data';numTrainData;'DirElmANN'};
    
    xlRange = 'D5';
    xlswrite(filename,A,sheet,xlRange)
    nodesANN = {'Input Nodes=';InputNode;'Hidden Nodes=';HiddenNode;'MinMAE=';MinMAE;'MinMAPE=';MAPE;'iter';NumItt};
