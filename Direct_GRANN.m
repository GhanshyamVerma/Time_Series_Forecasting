...
%     mu=mean(t_test);
    ...
    fprintf('itt u= %f',u);
    net=newgrnn(p_train,t_train,1.0);
...
%     '(12) Remove all Transformations if applied'};
    ...
    A = {'Minimum MSE=';MinMSE;'Size of Train Data';numTrainData;'DirGRANN'};
    
    xlRange = 'D5';
    xlswrite(filename,A,sheet,xlRange)
    nodesANN = {'Input Nodes=';InputNode;'Hidden Nodes=';HiddenNode;'NumItt';NumItt};
